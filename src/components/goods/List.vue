<template>
  <div>
    ...
    <el-card class="box-card">
       <el-row :gutter="20">
         <el-col :span="8">
           <el-input placeholder="请输入内容" v-model="params.query" clearable @clear="getGoodsList">
       ...
       <el-table :data="goodsList" stripe border style="width: 100%">
        ...
        <el-table-column prop="goods_price" label="商品价格(元)" width="85px"></el-table-column>
        ...
        <el-table-column label="操作" width="165px">
          <template v-slot="slotProps">
            ...
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeGoodsById(slotProps.row.goods_id)"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
export default {
  ...
  methods: {
    ...
    async removeGoodsById (id) {
      const confirmMsg = await this.$confirm('此操作将永久删除该商品, 是否继续?', '提示', {
